...
var opts = {
    "graph": {
        "value":"data/philosophers/dbpedia_philosophers_influencedBy_graph.json", 
        "values":[
            ...
            {value: "data/philosophers/dbpedia_philosophers_influencedBy_graph.json", label:"Philosophers influence"},
            {value: "data/co-occurences/SC_Persons_120201_cAll_graph.json", label:"Schnitzler Cooccurrences"}
